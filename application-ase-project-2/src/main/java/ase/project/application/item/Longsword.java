...
public class Longsword implements Weapon {
    private String name = "Cursed Longsword";
    private String description = "What is going on... Bent over, clutching your knees and out of breath, you see through teary eyes" +
